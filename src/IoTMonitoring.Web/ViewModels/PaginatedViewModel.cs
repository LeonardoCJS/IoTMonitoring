namespace IoTMonitoring.Web.ViewModels
{
    public class PaginatedViewModel<T> where T : class
    {
        ...
        public PaginatedViewModel(List<T> items, int count, int pageNumber, int pageSize, string sortBy = "", bool sortDescending = false)
        {
            Items = items;
            TotalCount = count;
    ...
    public class HomeViewModel
    {
        ...
        public List<SensorDataViewModel> RecentSensorData { get; set; } = new();
    }
}
